...
import { NSelect, NInput, NSlider, NButton, useMessage, NTag, NTooltip, NSwitch } from "naive-ui"
...
// 监听全局配置变化，同步base64ImageMode字段
watch(() => gptConfigStore.myData.base64ImageMode, (newValue) => {
	if (nGptStore.value.base64ImageMode !== newValue) {
		nGptStore.value.base64ImageMode = newValue;
	}
}, { immediate: true })
...
<template>
	...
	<section class="mb-5 flex justify-between items-center">
		<div style="margin-bottom: 8px;">Base64图片模式</div>
		<div class="flex justify-end items-center">
			<n-switch v-model:value="nGptStore.base64ImageMode" />
		</div>
	</section>
