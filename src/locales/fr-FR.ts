export default {
    ...
    "mj": {
        ...
        "upImg": "<span><b>Téléchargez une image</b><br/>Il invoquera automatiquement le modèle de prévisualisation gpt-4-vision<br>Remarque : Des frais supplémentaires peuvent s'appliquer pour les images supplémentaires<br/>Formats : jpeg, jpg, png, gif</span><p>Prise en charge du glisser-déposer</p> <p class=\"pt-2\"><b>Téléchargez MP3 MP4</b> <br>Il invoquera automatiquement le modèle SenseVoiceSmall<br>Formats : mp3, mp4, mpeg, mpga, m4a, wav, webm</p>",
