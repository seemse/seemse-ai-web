...
export default {
  ...
  mj:{
    ...
    ,upImg:'<span><b>上传图片</b><br/>注意：会有额外的图片费用<br/>格式: jpeg jpg png gif</span><p>支持拖拽</p> <p class="pt-2"><b>上传MP3 MP4</b> <br>会自动直接调用 SenseVoiceSmall 模型<br>格式有：mp3 mp4 mpeg mpga m4a wav webm</p>'
    ,clearAll:'清参数'
    ,czoom:'自定义'
    ,customTitle:'自定义变焦'
    ...
    ,micPermissionCheckFailed:'麦克风权限检查失败'
    ,micBrowserNotSupported:'浏览器不支持语音识别，请使用 Chrome 或 Edge 浏览器'
    ,micNoSpeechDetected:'未检测到语音，请确保麦克风正常工作'
    ,micNetworkError:'网络错误，请检查网络连接'
    ,micAborted:'语音识别被中断'
    ,micPermissionHelpTitle:'麦克风权限帮助'
    ,micPermissionWhyTitle:'为什么需要麦克风权限？'
    ,micPermissionWhyDesc:'为了使用语音识别功能，我们需要访问您的麦克风来录制音频。您的隐私对我们非常重要，录音仅用于实时识别，不会被存储或分享。'
    ,micPermissionHowTitle:'如何授予麦克风权限？'
    ,micPermissionStep1Title:'浏览器提示时点击"允许"'
    ,micPermissionStep1Desc:'当您首次使用语音功能时，浏览器会弹出权限请求，请点击"允许"。'
    ,micPermissionStep2Title:'检查浏览器设置'
    ,micPermissionStep2Desc:'如果错过了权限提示，请手动在浏览器设置中开启麦克风权限。'
    ,micPermissionStep3Title:'系统设置检查'
    ,micPermissionStep3Desc:'确保操作系统也允许浏览器访问麦克风。'
    ,micPermissionTroubleTitle:'常见问题解决'
    ,micPermissionProblem1Title:'权限被拒绝'
    ,micPermissionProblem1Desc:'请在浏览器设置中找到此网站，将麦克风权限改为"允许"，然后刷新页面重试。'
    ,micPermissionProblem2Title:'找不到麦克风设备'
    ,micPermissionProblem2Desc:'请确保麦克风已正确连接，并在系统设置中设为默认录音设备。'
    ,micPermissionProblem3Title:'浏览器不支持'
    ,micPermissionProblem3Desc:'请使用最新版本的 Chrome、Firefox、Safari 或 Edge 浏览器。'
    ,micPermissionProblem4Title:'HTTPS 要求'
    ,micPermissionProblem4Desc:'某些浏览器要求使用 HTTPS 协议才能访问麦克风。请确保您通过安全连接访问此网站。'
    ,micPermissionTipsTitle:'使用小贴士'
    ,micPermissionTip1:'在安静的环境中使用语音功能，以获得最佳识别效果'
    ,micPermissionTip2:'说话时保持适当的距离（约15-30厘米）'
    ,micPermissionTip3:'如果识别效果不佳，请检查麦克风质量或尝试调整输入音量'
    ,micPermissionTip4:'使用耳机麦克风可以减少背景噪音干扰'
