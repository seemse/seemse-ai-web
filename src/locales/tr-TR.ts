export default {
    ...
    "mj": {
        ...
        "upImg": "<span><b>Resim yükleyin</b><br/>Otomatik olarak gpt-4-vision-preview modelini çağırır<br>Not: Ek resim ücretleri uygulanabilir<br/>Formatlar: jpeg, jpg, png, gif</span><p>Sürükle ve bırak desteği</p> <p class=\"pt-2\"><b>MP3 MP4 Yükle</b> <br>Otomatik olarak SenseVoiceSmall modelini çağırır<br>Formatlar: mp3, mp4, mpeg, mpga, m4a, wav, webm</p>",
