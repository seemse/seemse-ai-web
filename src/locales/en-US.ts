export default {
  ...
  "upImg": "<span><b>Upload image</b><br/>Will automatically invoke the gpt-4-vision-preview model<br>Note: Additional image fees may apply<br/>Formats: jpeg, jpg, png, gif</span><p>Supports drag and drop</p> <p class=\"pt-2\"><b>Upload MP3 MP4</b> <br>Will automatically invoke the SenseVoiceSmall model<br>Formats: mp3, mp4, mpeg, mpga, m4a, wav, webm</p>",
  ...
  "micPermissionCheckFailed": "Microphone permission check failed",
  "micBrowserNotSupported": "Browser does not support speech recognition, please use Chrome or Edge browser",
  "micNoSpeechDetected": "No speech detected, please ensure microphone is working properly",
  "micNetworkError": "Network error, please check network connection",
  "micAborted": "Speech recognition interrupted",
    "micPermissionHelpTitle": "Microphone Permission Help",
    "micPermissionWhyTitle": "Why is microphone permission needed?",
    "micPermissionWhyDesc": "To use voice recognition features, we need access to your microphone to record audio. Your privacy is very important to us, and recordings are only used for real-time recognition and are not stored or shared.",
    "micPermissionHowTitle": "How to grant microphone permission?",
    "micPermissionStep1Title": "Click \"Allow\" when browser prompts",
    "micPermissionStep1Desc": "When you use voice features for the first time, the browser will show a permission request, please click \"Allow\".",
    "micPermissionStep2Title": "Check browser settings",
    "micPermissionStep2Desc": "If you missed the permission prompt, please manually enable microphone permission in browser settings.",
    "micPermissionStep3Title": "Check system settings",
    "micPermissionStep3Desc": "Make sure your operating system also allows the browser to access the microphone.",
    "micPermissionTroubleTitle": "Common Problem Solutions",
    "micPermissionProblem1Title": "Permission denied",
    "micPermissionProblem1Desc": "Please find this website in browser settings, change microphone permission to \"Allow\", then refresh the page and try again.",
    "micPermissionProblem2Title": "Microphone device not found",
    "micPermissionProblem2Desc": "Please ensure the microphone is properly connected and set as the default recording device in system settings.",
    "micPermissionProblem3Title": "Browser not supported",
    "micPermissionProblem3Desc": "Please use the latest version of Chrome, Firefox, Safari, or Edge browser.",
    "micPermissionProblem4Title": "HTTPS requirement",
    "micPermissionProblem4Desc": "Some browsers require HTTPS protocol to access the microphone. Please ensure you are accessing this website through a secure connection.",
    "micPermissionTipsTitle": "Usage Tips",
    "micPermissionTip1": "Use voice features in a quiet environment for best recognition results",
    "micPermissionTip2": "Maintain appropriate distance when speaking (about 15-30 cm)",
    "micPermissionTip3": "If recognition is poor, check microphone quality or try adjusting input volume",
    "micPermissionTip4": "Using a headset microphone can reduce background noise interference"
  },
